...
martingale_twoball_earning <- function(max_initial_earning, n) {
 ...
 data <- data.frame(earnings, winnings_distribution, plays_distribution)
  return(data)
}

x <- martingale_twoball_earning(100,10000)

plot(x$earnings, x$winnings_distribution,main = "Two-ball Martingale: Expected Earnings Distribution as initial Earnings Raises", type = "l")

plot(x$earnings, x$plays_distribution, main = "Two-ball Martingale: Expected # of plays as initial earnings raise", type = "l")
